...
from backend.database.db_setup import Transaction, db # Using the original database
from backend.fraud_detection.ml_model import predict_fraud
...
db_path = os.path.join(BASE_DIR, "backend", "instance", "transactions.db")
...
def process_and_insert_data():
    try:
        with open("data/fraud_transactions.json") as fraud_file, open("data/non_fraud_transactions.json") as non_fraud_file:
